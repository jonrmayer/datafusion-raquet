...
use arrow_array::{ArrayRef, BinaryArray, StructArray, BinaryViewArray,StringViewArray};
...
pub struct ParquetStatisticsTile {
    signature: Signature,
}

impl ParquetStatisticsTile {
    pub fn new() -> Self {
        Self {
...
impl Default for ParquetStatisticsTile {
    fn default() -> Self {
        Self::new()
    }
}
