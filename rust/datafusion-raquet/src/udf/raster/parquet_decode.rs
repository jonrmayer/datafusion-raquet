...
pub struct ParquetDecodeTile {
    signature: Signature,
}

impl ParquetDecodeTile {
    pub fn new() -> Self {
        Self {
...
impl Default for ParquetDecodeTile {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ScalarUDFImpl for ParquetDecodeTile {
    fn name(&self) -> &str {
        "parquet_decode_tile"
    }
...
mod tests {
    ...
    async fn test_decode_tile_parquet() {
        ...
        select parquet_decode_tile(data.band_1,n.meta) from data,n
